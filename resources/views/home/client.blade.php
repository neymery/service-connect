...
<style>
    ...
    /* Styles spécifiques pour les icônes des cartes principales */
    .feature-card .fas {
        width: 70px;
        height: 70px;
        border-radius: 50%;
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="card h-100 feature-card animate-fade-in delay-100">
                ...
                <div class="col-md-4">
                    <div class="card h-100 feature-card animate-fade-in delay-200">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4">
                    <div class="card h-100 feature-card animate-fade-in delay-300">
                        <div class="card-body text-center">
